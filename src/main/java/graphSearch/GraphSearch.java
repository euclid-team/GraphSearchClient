...
//
        ...
        // res.maxDistance (The maximum distance from the first node)
        // res.graphDiameter (The diameter of the graph, i.e., the maximum distance between any pair of nodes)
