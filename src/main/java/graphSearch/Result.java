...
public class Result implements Serializable {
    ...
    public static final int BIT_MAX_DISTANCE_HOPS = 0b1 << 2;
    ...
    public static final int BIT_GRAPH_DIAMETER = 0b1 << 24; // Graph diameter
    public static final int BIT_MAX_DISTANCE = 0b1 << 25; // max distance (weighted path) from source node

    public static final int BIT_MASK_GRAPH_SEARCH_2025_COMPULSORY = BIT_N | BIT_M | BIT_BFS_NODE_SEQUENCE | BIT_DFS_NODE_SEQUENCE;
    public static final int BIT_MASK_GRAPH_SEARCH_2025_BONUS = BIT_MAX_DISTANCE | BIT_GRAPH_DIAMETER;
    ...
    public static boolean assessmentCompulsoryQuestions(long res) {
        ...
        long compRes = res & Result.BIT_MASK_GRAPH_SEARCH_2025_COMPULSORY;
    ...
    public static boolean assessmentBonusQuestions(long res) {
        ...
        long bonusRes = res & Result.BIT_MASK_GRAPH_SEARCH_2025_BONUS;
    ...
    long maxDistanceHops; // The max distance in hops (number of edges from the start node)
    Long maxDistance; // The max distance (weighted path)
    Long graphDiameter; // The max distance between any pair of nodes
...
//		opponentMove = new PlayerMove(Finals.DEFAULT_MAX_NUM_OF_NODE_BRIBES, Finals.DEFAULT_MAX_TOTAL_BRIBE);
    ...
    public Long getMaxDistanceHops() {
...
//		info += "\n(bonus) Max distance hops (" + maxDistanceHops + ") -> " + (((assessment & BIT_MAX_DISTANCE_HOPS) == 0)? "OK": "Wrong answer");
        info += "\n(bonus) Max distance (" + maxDistance + ") -> " + (((assessment & BIT_MAX_DISTANCE) == 0)? "OK": "Wrong answer");
        info += "\n(bonus) Graph diameter (" + graphDiameter + ") -> " + (((assessment & BIT_GRAPH_DIAMETER) == 0)? "OK": "Wrong answer");
